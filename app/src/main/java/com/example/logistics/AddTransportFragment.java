...
public class AddTransportFragment extends Fragment implements PermissionsListener, OnMapReadyCallback {
...
// Toast instructing user to tap on the mapboxMap
                Toast.makeText(
                        activity,
                        "movete", Toast.LENGTH_SHORT).show();
...
// Transform the appearance of the button to become the cancel button
                            ...
                            selectLocationButton.setText("Scancella");
...
// Switch the button appearance back to select a location.
                            ...
                            selectLocationButton.setText("Seleziona");
