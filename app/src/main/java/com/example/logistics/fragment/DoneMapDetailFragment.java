...
public class DoneMapDetailFragment extends Fragment {

    public static final String DONE_MAP_FRAGMENT = "Done_Map_Fragment";
    private Activity activity;
    private MapView doneMapView;
    private List<CardItemCompany> done;
    private MapboxMap mapboxMap;
    private boolean fromDriver;
    private String formattedDate;

    public DoneMapDetailFragment(List<CardItemCompany> done){
        this.done = done;
        this.fromDriver = false;
    }

    public DoneMapDetailFragment(List<CardItemCompany> done, boolean fromDriver){
        this.done = done;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.done_map_fragment, container, false);
        return layout;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        doneMapView = view.findViewById(R.id.doneMapView);
        doneMapView.onCreate(savedInstanceState);
        doneMapView.getMapAsync(new OnMapReadyCallback() {
            @Override
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                DoneMapDetailFragment.this.mapboxMap = mapboxMap;
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    @Override
                    public void onStyleLoaded(@NonNull Style style) {
                        for (CardItemCompany cardItemCompany : done) {
        ...
        if(!fromDriver){
            view.findViewById(R.id.driverDateFilterDone).setOnClickListener(new View.OnClickListener() {
                                    ...
                                    .setPositiveButton("Go", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            mapboxMap.getStyle(new Style.OnStyleLoaded() {
                                                @Override
                                                public void onStyleLoaded(@NonNull Style style) {
                                                    for (CardItemCompany availableItem : DoneMapDetailFragment.this.done) {
            ...
            Button dateButtonAv = view.findViewById(R.id.driverDateFilterDone);
        ...
        view.findViewById(R.id.productFilterDone).setOnClickListener(new View.OnClickListener() {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        doneMapView.onSaveInstanceState(outState);
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        doneMapView.onDestroy();
    }

    @Override
    public void onLowMemory() {
        super.onLowMemory();
        doneMapView.onLowMemory();
    }
}
